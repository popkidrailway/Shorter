...
module.exports = {
    ...
    DATABASE_URL: process.env.DATABASE_URL || "mongodb+srv://popkid:<db_password>@cluster0.i50ot50.mongodb.net/?appName=Cluster0", // Your Db URL here(optional). Can either be mongodb or postreSQL
